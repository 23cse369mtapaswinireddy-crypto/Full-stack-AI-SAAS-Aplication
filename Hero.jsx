  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      ...
      <div className='text-center mb-6'>
        ...
        <p className='mt-4 max-w-xs sm:max-w-1g 2x1:max-w-xl m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools. 
